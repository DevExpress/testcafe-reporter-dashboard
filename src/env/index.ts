...
export const LT_SCREENSHOTS_RELATIVE_PATH = env.TESTCAFE_DASHBOARD_DEVEXTREME_LT_SCREENSHOTS_RELATIVE_PATH;
export const LT_DESTINATION_RELATIVE_PATH = env.TESTCAFE_DASHBOARD_DEVEXTREME_LT_DESTINATION_RELATIVE_PATH;
export const LT_COMPARER_BASE_PATH        = env.TESTCAFE_DASHBOARD_DEVEXTREME_LT_COMPARER_BASE_PATH;
