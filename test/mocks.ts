...
export const stashLayoutSettingsVariables = () => {
    originalVariables.TESTCAFE_DASHBOARD_LAYOUT_TESTING_ENABLED = process.env.TESTCAFE_DASHBOARD_DEVEXTREME_LAYOUT_TESTING_ENABLED;
    originalVariables.TESTCAFE_DASHBOARD_LT_SCREENSHOTS_DIR     = process.env.TESTCAFE_DASHBOARD_DEVEXTREME_LT_SCREENSHOTS_DIR;
    originalVariables.TESTCAFE_DASHBOARD_LT_DESTINATION_DIR     = process.env.TESTCAFE_DASHBOARD_DEVEXTREME_LT_DESTINATION_DIR;
};

export const restoreLayoutSettingsVariables = () => {
    process.env.TESTCAFE_DASHBOARD_DEVEXTREME_LAYOUT_TESTING_ENABLED = originalVariables.TESTCAFE_DASHBOARD_LAYOUT_TESTING_ENABLED;
    process.env.TESTCAFE_DASHBOARD_DEVEXTREME_LT_SCREENSHOTS_DIR     = originalVariables.TESTCAFE_DASHBOARD_LT_SCREENSHOTS_DIR;
    process.env.TESTCAFE_DASHBOARD_DEVEXTREME_LT_DESTINATION_DIR     = originalVariables.TESTCAFE_DASHBOARD_LT_DESTINATION_DIR;
};
